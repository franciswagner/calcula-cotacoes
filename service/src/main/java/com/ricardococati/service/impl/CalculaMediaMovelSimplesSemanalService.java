...
public class CalculaMediaMovelSimplesSemanalService
    implements ICalculaMediaMovelSimplesSemanalService {

  private static final int PRIMEIRA_POSICAO = 0;
  private static final Boolean MEDIA_MOVEL_SIMPLES_NAO_GERADA = false;
  private final ICandlestickSemanalService semanalService;

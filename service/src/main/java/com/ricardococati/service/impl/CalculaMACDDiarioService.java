...
public class CalculaMACDDiarioService
    implements ICalculaMACDDiarioService {

  private final ICandlestickDiarioService candleDiarioService;
  private final IMediaMovelExponencialDiarioDAO mmeDAO;

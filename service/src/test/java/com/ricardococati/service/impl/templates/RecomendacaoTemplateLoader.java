  ...
  public void load() {
    Fixture.of(Recomendacao.class)
        .addTemplate(RECOMENDACAO_VALID_001,
            new Rule() {{
              add("codneg", "MGLU3");
              add("precoFechamento", new BigDecimal(11.11).setScale(4, BigDecimal.ROUND_HALF_UP));
              add("precoMME12p", new BigDecimal(11.75).setScale(4, BigDecimal.ROUND_HALF_UP));
              add("precoMME26p", new BigDecimal(12.36).setScale(4, BigDecimal.ROUND_HALF_UP));
              add("precoMacd", new BigDecimal(-0.61).setScale(4, BigDecimal.ROUND_HALF_UP));
              add("precoSinalMacd", new BigDecimal(-0.48).setScale(4, BigDecimal.ROUND_HALF_UP));
              add("precoHistograma", new BigDecimal(-0.13).setScale(4, BigDecimal.ROUND_HALF_UP));
              add("decisao", "VENDE");
            }})
        .addTemplate(RECOMENDACAO_VALID_002).inherits(RECOMENDACAO_VALID_001,
        new Rule() {{
          add("precoFechamento", new BigDecimal(11.05).setScale(4, BigDecimal.ROUND_HALF_UP));
          add("precoMME12p", new BigDecimal(11.64).setScale(4, BigDecimal.ROUND_HALF_UP));
          add("precoMME26p", new BigDecimal(12.27).setScale(4, BigDecimal.ROUND_HALF_UP));
          add("precoMacd", new BigDecimal(-0.63).setScale(4, BigDecimal.ROUND_HALF_UP));
          add("precoSinalMacd", new BigDecimal(-0.51).setScale(4, BigDecimal.ROUND_HALF_UP));
          add("precoHistograma", new BigDecimal(-0.12).setScale(4, BigDecimal.ROUND_HALF_UP));
        }})

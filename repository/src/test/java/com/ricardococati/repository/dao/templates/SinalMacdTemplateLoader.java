  ...
  public void load() {
    Fixture.of(SinalMacd.class)
        .addTemplate(SINAL_MACD_VALID_001,
            new Rule() {{
              add("codneg", "MGLU3");
              add("presinal", getValueBigDecimalHalfUpArredondado4Casas(12.11));
            }})
        .addTemplate(SINAL_MACD_VALID_002).inherits(SINAL_MACD_VALID_001,
        new Rule() {{
          add("presinal", getValueBigDecimalHalfUpArredondado4Casas(9.9));
        }})
        .addTemplate(SINAL_MACD_VALID_003).inherits(SINAL_MACD_VALID_001,
        new Rule() {{
          add("presinal", getValueBigDecimalHalfUpArredondado4Casas(9.23));
        }})
        .addTemplate(SINAL_MACD_VALID_004).inherits(SINAL_MACD_VALID_001,
        new Rule() {{
          add("presinal", getValueBigDecimalHalfUpArredondado4Casas(9.32));
        }})
        .addTemplate(SINAL_MACD_VALID_005).inherits(SINAL_MACD_VALID_001,
        new Rule() {{
          add("presinal", getValueBigDecimalHalfUpArredondado4Casas(9.54));
        }})
        .addTemplate(SINAL_MACD_VALID_006).inherits(SINAL_MACD_VALID_001,
        new Rule() {{
          add("presinal", getValueBigDecimalHalfUpArredondado4Casas(12.2));
        }})
        .addTemplate(SINAL_MACD_VALID_007).inherits(SINAL_MACD_VALID_001,
        new Rule() {{
          add("presinal", getValueBigDecimalHalfUpArredondado4Casas(12.3));
        }})
        .addTemplate(SINAL_MACD_VALID_007).inherits(SINAL_MACD_VALID_001,
        new Rule() {{
          add("presinal", getValueBigDecimalHalfUpArredondado4Casas(12.1));
        }})
        .addTemplate(SINAL_MACD_VALID_008).inherits(SINAL_MACD_VALID_001,
        new Rule() {{
          add("presinal", getValueBigDecimalHalfUpArredondado4Casas(9.4));
        }})
        .addTemplate(SINAL_MACD_VALID_009).inherits(SINAL_MACD_VALID_001,
        new Rule() {{
          add("presinal", getValueBigDecimalHalfUpArredondado4Casas(9.37));
        }})
        .addTemplate(SINAL_MACD_VALID_010).inherits(SINAL_MACD_VALID_001,
        new Rule() {{
          add("presinal", getValueBigDecimalHalfUpArredondado4Casas(9.56));
        }})
        .addTemplate(SINAL_MACD_VALID_011).inherits(SINAL_MACD_VALID_001,
        new Rule() {{
          add("presinal", getValueBigDecimalHalfUpArredondado4Casas(9.76));
        }});
  }
}
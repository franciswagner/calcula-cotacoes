  ...
  public void load() {
    Fixture.of(MediaMovelExponencial.class)
        .addTemplate(MEDIA_MOVEL_EXPONENCIAL_12PERIODOS_VALID_001, new Rule() {{
          add("codneg", "MGLU3");
          add("premedult", getValueBigDecimalHalfUpArredondado4Casas(13.11));
          add("periodo", 12);
        }})
        .addTemplate(MEDIA_MOVEL_EXPONENCIAL_12PERIODOS_VALID_002)
        .inherits(MEDIA_MOVEL_EXPONENCIAL_12PERIODOS_VALID_001, new Rule() {{
          add("premedult", getValueBigDecimalHalfUpArredondado4Casas(13.9));
        }})
        .addTemplate(MEDIA_MOVEL_EXPONENCIAL_12PERIODOS_VALID_003)
        .inherits(MEDIA_MOVEL_EXPONENCIAL_12PERIODOS_VALID_001, new Rule() {{
          add("premedult", getValueBigDecimalHalfUpArredondado4Casas(13.23));
        }})
        .addTemplate(MEDIA_MOVEL_EXPONENCIAL_12PERIODOS_VALID_004)
        .inherits(MEDIA_MOVEL_EXPONENCIAL_12PERIODOS_VALID_001, new Rule() {{
          add("premedult", getValueBigDecimalHalfUpArredondado4Casas(13.32));
        }})
        .addTemplate(MEDIA_MOVEL_EXPONENCIAL_12PERIODOS_VALID_005)
        .inherits(MEDIA_MOVEL_EXPONENCIAL_12PERIODOS_VALID_001, new Rule() {{
          add("premedult", getValueBigDecimalHalfUpArredondado4Casas(13.54));
        }})
        .addTemplate(MEDIA_MOVEL_EXPONENCIAL_12PERIODOS_VALID_006)
        .inherits(MEDIA_MOVEL_EXPONENCIAL_12PERIODOS_VALID_001, new Rule() {{
          add("premedult", getValueBigDecimalHalfUpArredondado4Casas(13.2));
        }})
        .addTemplate(MEDIA_MOVEL_EXPONENCIAL_12PERIODOS_VALID_007)
        .inherits(MEDIA_MOVEL_EXPONENCIAL_12PERIODOS_VALID_001, new Rule() {{
          add("premedult", getValueBigDecimalHalfUpArredondado4Casas(13.3));
        }})
        .addTemplate(MEDIA_MOVEL_EXPONENCIAL_12PERIODOS_VALID_007)
        .inherits(MEDIA_MOVEL_EXPONENCIAL_12PERIODOS_VALID_001, new Rule() {{
          add("premedult", getValueBigDecimalHalfUpArredondado4Casas(13.1));
        }})
        .addTemplate(MEDIA_MOVEL_EXPONENCIAL_12PERIODOS_VALID_008)
        .inherits(MEDIA_MOVEL_EXPONENCIAL_12PERIODOS_VALID_001, new Rule() {{
          add("premedult", getValueBigDecimalHalfUpArredondado4Casas(13.4));
        }})
        .addTemplate(MEDIA_MOVEL_EXPONENCIAL_12PERIODOS_VALID_009)
        .inherits(MEDIA_MOVEL_EXPONENCIAL_12PERIODOS_VALID_001, new Rule() {{
          add("premedult", getValueBigDecimalHalfUpArredondado4Casas(13.37));
        }})
        .addTemplate(MEDIA_MOVEL_EXPONENCIAL_12PERIODOS_VALID_010)
        .inherits(MEDIA_MOVEL_EXPONENCIAL_12PERIODOS_VALID_001, new Rule() {{
          add("premedult", getValueBigDecimalHalfUpArredondado4Casas(13.56));
        }})
        .addTemplate(MEDIA_MOVEL_EXPONENCIAL_12PERIODOS_VALID_011)
        .inherits(MEDIA_MOVEL_EXPONENCIAL_12PERIODOS_VALID_001, new Rule() {{
          add("premedult", getValueBigDecimalHalfUpArredondado4Casas(13.76));
        }})
        .addTemplate(MEDIA_MOVEL_EXPONENCIAL_12PERIODOS_VALID_012)
        .inherits(MEDIA_MOVEL_EXPONENCIAL_12PERIODOS_VALID_001, new Rule() {{
          add("premedult", getValueBigDecimalHalfUpArredondado4Casas(13.12));
        }})
        .addTemplate(MEDIA_MOVEL_EXPONENCIAL_12PERIODOS_VALID_013)
        .inherits(MEDIA_MOVEL_EXPONENCIAL_12PERIODOS_VALID_001, new Rule() {{
          add("premedult", getValueBigDecimalHalfUpArredondado4Casas(13.13));
        }})
        .addTemplate(MEDIA_MOVEL_EXPONENCIAL_12PERIODOS_VALID_014)
        .inherits(MEDIA_MOVEL_EXPONENCIAL_12PERIODOS_VALID_001, new Rule() {{
          add("premedult", getValueBigDecimalHalfUpArredondado4Casas(13.14));
        }})
        .addTemplate(MEDIA_MOVEL_EXPONENCIAL_12PERIODOS_VALID_015)
        .inherits(MEDIA_MOVEL_EXPONENCIAL_12PERIODOS_VALID_001, new Rule() {{
          add("premedult", getValueBigDecimalHalfUpArredondado4Casas(13.15));
        }})
        .addTemplate(MEDIA_MOVEL_EXPONENCIAL_12PERIODOS_VALID_016)
        .inherits(MEDIA_MOVEL_EXPONENCIAL_12PERIODOS_VALID_001, new Rule() {{
          add("premedult", getValueBigDecimalHalfUpArredondado4Casas(13.16));
        }})
        .addTemplate(MEDIA_MOVEL_EXPONENCIAL_12PERIODOS_VALID_017)
        .inherits(MEDIA_MOVEL_EXPONENCIAL_12PERIODOS_VALID_001, new Rule() {{
          add("premedult", getValueBigDecimalHalfUpArredondado4Casas(13.17));
        }})
        .addTemplate(MEDIA_MOVEL_EXPONENCIAL_12PERIODOS_VALID_018)
        .inherits(MEDIA_MOVEL_EXPONENCIAL_12PERIODOS_VALID_001, new Rule() {{
          add("premedult", getValueBigDecimalHalfUpArredondado4Casas(13.18));
        }})
        .addTemplate(MEDIA_MOVEL_EXPONENCIAL_12PERIODOS_VALID_018)
        .inherits(MEDIA_MOVEL_EXPONENCIAL_12PERIODOS_VALID_001, new Rule() {{
          add("premedult", getValueBigDecimalHalfUpArredondado4Casas(13.18));
        ...
        .inherits(MEDIA_MOVEL_EXPONENCIAL_12PERIODOS_VALID_001, new Rule() {{
          add("premedult", getValueBigDecimalHalfUpArredondado4Casas(13.19));
        }})
        .addTemplate(MEDIA_MOVEL_EXPONENCIAL_12PERIODOS_VALID_020)
        .inherits(MEDIA_MOVEL_EXPONENCIAL_12PERIODOS_VALID_001, new Rule() {{
          add("premedult", getValueBigDecimalHalfUpArredondado4Casas(13.20));
        }})
        .addTemplate(MEDIA_MOVEL_EXPONENCIAL_12PERIODOS_VALID_021)
        .inherits(MEDIA_MOVEL_EXPONENCIAL_12PERIODOS_VALID_001, new Rule() {{
          add("premedult", getValueBigDecimalHalfUpArredondado4Casas(13.21));
        }})
        .addTemplate(MEDIA_MOVEL_EXPONENCIAL_12PERIODOS_VALID_022)
        .inherits(MEDIA_MOVEL_EXPONENCIAL_12PERIODOS_VALID_001, new Rule() {{
          add("premedult", getValueBigDecimalHalfUpArredondado4Casas(13.22));
        }})
        ...
        .inherits(MEDIA_MOVEL_EXPONENCIAL_12PERIODOS_VALID_001, new Rule() {{
          add("premedult", getValueBigDecimalHalfUpArredondado4Casas(13.24));
        }})
        .addTemplate(MEDIA_MOVEL_EXPONENCIAL_12PERIODOS_VALID_025)
        .inherits(MEDIA_MOVEL_EXPONENCIAL_12PERIODOS_VALID_001, new Rule() {{
          add("premedult", getValueBigDecimalHalfUpArredondado4Casas(13.25));
        }})
        .addTemplate(MEDIA_MOVEL_EXPONENCIAL_12PERIODOS_VALID_026)
        .inherits(MEDIA_MOVEL_EXPONENCIAL_12PERIODOS_VALID_001, new Rule() {{
          add("premedult", getValueBigDecimalHalfUpArredondado4Casas(13.26));
        }})
        .addTemplate(MEDIA_MOVEL_EXPONENCIAL_12PERIODOS_VALID_027)
        .inherits(MEDIA_MOVEL_EXPONENCIAL_12PERIODOS_VALID_001, new Rule() {{
          add("premedult", getValueBigDecimalHalfUpArredondado4Casas(13.27));
        }})
        .addTemplate(MEDIA_MOVEL_EXPONENCIAL_12PERIODOS_VALID_028)
        .inherits(MEDIA_MOVEL_EXPONENCIAL_12PERIODOS_VALID_001, new Rule() {{
          add("premedult", getValueBigDecimalHalfUpArredondado4Casas(13.28));
        }})
        .addTemplate(MEDIA_MOVEL_EXPONENCIAL_12PERIODOS_VALID_029)
        .inherits(MEDIA_MOVEL_EXPONENCIAL_12PERIODOS_VALID_001, new Rule() {{
          add("premedult", getValueBigDecimalHalfUpArredondado4Casas(13.29));
        }})
        .addTemplate(MEDIA_MOVEL_EXPONENCIAL_12PERIODOS_VALID_030)
        .inherits(MEDIA_MOVEL_EXPONENCIAL_12PERIODOS_VALID_001, new Rule() {{
          add("premedult", getValueBigDecimalHalfUpArredondado4Casas(13.30));
        }});
  }
}
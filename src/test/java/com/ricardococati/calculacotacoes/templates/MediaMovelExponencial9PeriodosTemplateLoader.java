...
public class MediaMovelExponencial9PeriodosTemplateLoader implements TemplateLoader {
  ...
  public void load() {
    Fixture.of(MediaMovelExponencial.class)
        ...
        .inherits(MEDIA_MOVEL_EXPONENCIAL_9PERIODOS_VALID_001, new Rule() {{
          add("premedult", sendDoubleGetValueBigDecimalArredonda4Casas(10.12));
        }})
        .addTemplate(MEDIA_MOVEL_EXPONENCIAL_9PERIODOS_VALID_013)
        .inherits(MEDIA_MOVEL_EXPONENCIAL_9PERIODOS_VALID_001, new Rule() {{
          add("premedult", sendDoubleGetValueBigDecimalArredonda4Casas(10.13));
        }})
        .addTemplate(MEDIA_MOVEL_EXPONENCIAL_9PERIODOS_VALID_014)
        .inherits(MEDIA_MOVEL_EXPONENCIAL_9PERIODOS_VALID_001, new Rule() {{
          add("premedult", sendDoubleGetValueBigDecimalArredonda4Casas(10.14));
        }})
        .addTemplate(MEDIA_MOVEL_EXPONENCIAL_9PERIODOS_VALID_015)
        .inherits(MEDIA_MOVEL_EXPONENCIAL_9PERIODOS_VALID_001, new Rule() {{
          add("premedult", sendDoubleGetValueBigDecimalArredonda4Casas(10.15));
        }})
        .addTemplate(MEDIA_MOVEL_EXPONENCIAL_9PERIODOS_VALID_016)
        .inherits(MEDIA_MOVEL_EXPONENCIAL_9PERIODOS_VALID_001, new Rule() {{
          add("premedult", sendDoubleGetValueBigDecimalArredonda4Casas(10.16));
        }})
        .addTemplate(MEDIA_MOVEL_EXPONENCIAL_9PERIODOS_VALID_017)
        .inherits(MEDIA_MOVEL_EXPONENCIAL_9PERIODOS_VALID_001, new Rule() {{
          add("premedult", sendDoubleGetValueBigDecimalArredonda4Casas(10.17));
        }})
        .addTemplate(MEDIA_MOVEL_EXPONENCIAL_9PERIODOS_VALID_018)
        .inherits(MEDIA_MOVEL_EXPONENCIAL_9PERIODOS_VALID_001, new Rule() {{
          add("premedult", sendDoubleGetValueBigDecimalArredonda4Casas(10.18));
        }})
        .addTemplate(MEDIA_MOVEL_EXPONENCIAL_9PERIODOS_VALID_018)
        .inherits(MEDIA_MOVEL_EXPONENCIAL_9PERIODOS_VALID_001, new Rule() {{
          add("premedult", sendDoubleGetValueBigDecimalArredonda4Casas(10.18));
        ...
        .inherits(MEDIA_MOVEL_EXPONENCIAL_9PERIODOS_VALID_001, new Rule() {{
          add("premedult", sendDoubleGetValueBigDecimalArredonda4Casas(10.19));
        }})
        .addTemplate(MEDIA_MOVEL_EXPONENCIAL_9PERIODOS_VALID_020)
        .inherits(MEDIA_MOVEL_EXPONENCIAL_9PERIODOS_VALID_001, new Rule() {{
          add("premedult", sendDoubleGetValueBigDecimalArredonda4Casas(10.20));
        }})
        .addTemplate(MEDIA_MOVEL_EXPONENCIAL_9PERIODOS_VALID_021)
        .inherits(MEDIA_MOVEL_EXPONENCIAL_9PERIODOS_VALID_001, new Rule() {{
          add("premedult", sendDoubleGetValueBigDecimalArredonda4Casas(10.21));
        }})
        .addTemplate(MEDIA_MOVEL_EXPONENCIAL_9PERIODOS_VALID_022)
        .inherits(MEDIA_MOVEL_EXPONENCIAL_9PERIODOS_VALID_001, new Rule() {{
          add("premedult", sendDoubleGetValueBigDecimalArredonda4Casas(10.22));
        }})
        ...
        .inherits(MEDIA_MOVEL_EXPONENCIAL_9PERIODOS_VALID_001, new Rule() {{
          add("premedult", sendDoubleGetValueBigDecimalArredonda4Casas(10.24));
        }})
        .addTemplate(MEDIA_MOVEL_EXPONENCIAL_9PERIODOS_VALID_025)
        .inherits(MEDIA_MOVEL_EXPONENCIAL_9PERIODOS_VALID_001, new Rule() {{
          add("premedult", sendDoubleGetValueBigDecimalArredonda4Casas(10.25));
        }})
        .addTemplate(MEDIA_MOVEL_EXPONENCIAL_9PERIODOS_VALID_026)
        .inherits(MEDIA_MOVEL_EXPONENCIAL_9PERIODOS_VALID_001, new Rule() {{
          add("premedult", sendDoubleGetValueBigDecimalArredonda4Casas(10.26));
        }})
        .addTemplate(MEDIA_MOVEL_EXPONENCIAL_9PERIODOS_VALID_027)
        .inherits(MEDIA_MOVEL_EXPONENCIAL_9PERIODOS_VALID_001, new Rule() {{
          add("premedult", sendDoubleGetValueBigDecimalArredonda4Casas(10.27));
        }})
        .addTemplate(MEDIA_MOVEL_EXPONENCIAL_9PERIODOS_VALID_028)
        .inherits(MEDIA_MOVEL_EXPONENCIAL_9PERIODOS_VALID_001, new Rule() {{
          add("premedult", sendDoubleGetValueBigDecimalArredonda4Casas(10.28));
        }})
        .addTemplate(MEDIA_MOVEL_EXPONENCIAL_9PERIODOS_VALID_029)
        .inherits(MEDIA_MOVEL_EXPONENCIAL_9PERIODOS_VALID_001, new Rule() {{
          add("premedult", sendDoubleGetValueBigDecimalArredonda4Casas(10.29));
        }})
        .addTemplate(MEDIA_MOVEL_EXPONENCIAL_9PERIODOS_VALID_030)
        .inherits(MEDIA_MOVEL_EXPONENCIAL_9PERIODOS_VALID_001, new Rule() {{
          add("premedult", sendDoubleGetValueBigDecimalArredonda4Casas(10.30));
        }});
  }
}
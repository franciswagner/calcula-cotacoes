    ...
    Fixture.of(Histograma.class)
        .addTemplate(HISTOGRAMA_VALID_001,
            new Rule() {{
              add("codneg", "MGLU3");
              add("prehist",
                  sendDoubleGetValueBigDecimalArredonda4Casas(11.11));
            }})
        .addTemplate(HISTOGRAMA_VALID_002).inherits(HISTOGRAMA_VALID_001,
        new Rule() {{
          add("prehist", sendDoubleGetValueBigDecimalArredonda4Casas(10.9));
        }})
        .addTemplate(HISTOGRAMA_VALID_003).inherits(HISTOGRAMA_VALID_001,
        new Rule() {{
          add("prehist", sendDoubleGetValueBigDecimalArredonda4Casas(10.23));
        }})
        .addTemplate(HISTOGRAMA_VALID_004).inherits(HISTOGRAMA_VALID_001,
        new Rule() {{
          add("prehist", sendDoubleGetValueBigDecimalArredonda4Casas(10.32));
        }})
        .addTemplate(HISTOGRAMA_VALID_005).inherits(HISTOGRAMA_VALID_001,
        new Rule() {{
          add("prehist", sendDoubleGetValueBigDecimalArredonda4Casas(10.54));
        }})
        .addTemplate(HISTOGRAMA_VALID_006).inherits(HISTOGRAMA_VALID_001,
        new Rule() {{
          add("prehist", sendDoubleGetValueBigDecimalArredonda4Casas(11.2));
        }})
        .addTemplate(HISTOGRAMA_VALID_007).inherits(HISTOGRAMA_VALID_001,
        new Rule() {{
          add("prehist", sendDoubleGetValueBigDecimalArredonda4Casas(11.3));
        }})
        .addTemplate(HISTOGRAMA_VALID_007).inherits(HISTOGRAMA_VALID_001,
        new Rule() {{
          add("prehist", sendDoubleGetValueBigDecimalArredonda4Casas(11.1));
        }})
        .addTemplate(HISTOGRAMA_VALID_008).inherits(HISTOGRAMA_VALID_001,
        new Rule() {{
          add("prehist", sendDoubleGetValueBigDecimalArredonda4Casas(10.4));
        }})
        .addTemplate(HISTOGRAMA_VALID_009).inherits(HISTOGRAMA_VALID_001,
        new Rule() {{
          add("prehist", sendDoubleGetValueBigDecimalArredonda4Casas(10.37));
        }})
        .addTemplate(HISTOGRAMA_VALID_010).inherits(HISTOGRAMA_VALID_001,
        new Rule() {{
          add("prehist", sendDoubleGetValueBigDecimalArredonda4Casas(10.56));
        }})
        .addTemplate(HISTOGRAMA_VALID_011).inherits(HISTOGRAMA_VALID_001,
        new Rule() {{
          add("prehist", sendDoubleGetValueBigDecimalArredonda4Casas(10.76));
        }});
  }
}
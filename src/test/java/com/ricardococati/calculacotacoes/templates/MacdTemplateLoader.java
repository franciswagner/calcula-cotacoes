  ...
  public void load() {
    Fixture.of(Macd.class)
        .addTemplate(MACD_VALID_001,
            new Rule() {{
              add("codneg", "MGLU3");
              add("premacd", sendDoubleGetValueBigDecimalArredonda4Casas(11.11));
            }})
        .addTemplate(MACD_VALID_002).inherits(MACD_VALID_001,
        new Rule() {{
          add("premacd", sendDoubleGetValueBigDecimalArredonda4Casas(10.9));
        }})
        .addTemplate(MACD_VALID_003).inherits(MACD_VALID_001,
        new Rule() {{
          add("premacd", sendDoubleGetValueBigDecimalArredonda4Casas(10.23));
        }})
        .addTemplate(MACD_VALID_004).inherits(MACD_VALID_001,
        new Rule() {{
          add("premacd", sendDoubleGetValueBigDecimalArredonda4Casas(10.32));
        }})
        .addTemplate(MACD_VALID_005).inherits(MACD_VALID_001,
        new Rule() {{
          add("premacd", sendDoubleGetValueBigDecimalArredonda4Casas(10.54));
        }})
        .addTemplate(MACD_VALID_006).inherits(MACD_VALID_001,
        new Rule() {{
          add("premacd", sendDoubleGetValueBigDecimalArredonda4Casas(11.2));
        }})
        .addTemplate(MACD_VALID_007).inherits(MACD_VALID_001,
        new Rule() {{
          add("premacd", sendDoubleGetValueBigDecimalArredonda4Casas(11.3));
        }})
        .addTemplate(MACD_VALID_007).inherits(MACD_VALID_001,
        new Rule() {{
          add("premacd", sendDoubleGetValueBigDecimalArredonda4Casas(11.1));
        }})
        .addTemplate(MACD_VALID_008).inherits(MACD_VALID_001,
        new Rule() {{
          add("premacd", sendDoubleGetValueBigDecimalArredonda4Casas(10.4));
        }})
        .addTemplate(MACD_VALID_009).inherits(MACD_VALID_001,
        new Rule() {{
          add("premacd", sendDoubleGetValueBigDecimalArredonda4Casas(10.37));
        }})
        .addTemplate(MACD_VALID_010).inherits(MACD_VALID_001,
        new Rule() {{
          add("premacd", sendDoubleGetValueBigDecimalArredonda4Casas(10.56));
        }})
        .addTemplate(MACD_VALID_011).inherits(MACD_VALID_001,
        new Rule() {{
          add("premacd", sendDoubleGetValueBigDecimalArredonda4Casas(10.76));
        }});
  }
}